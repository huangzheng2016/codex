...
const AUTO_REVIEW_APPROVAL_SUFFIX: &str =
    "`approvals_reviewer` is `auto_review`: All actions are automatically approved.";
...
mod tests {
    ...
    fn guardian_subagent_approvals_append_guardian_specific_guidance() {
        ...
        assert!(text.contains("All actions are automatically approved."));
    }
